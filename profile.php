...
<body>
            ...
            <div class="top-right-part">
                <div class="top-pic-name-wrap">
                    <a href="profile.php?username=<?php echo $userData->userLink; ?>" class="top-pic-name">
                        ...
                        <span class="top-name top-css border-left"><?php echo $userData->firstName; ?></span>
                    </a>
                </div>
                <a href="index.php">
                ...
                <div class="top-request top-css top-icon border-left">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.8 13.63" class="request-svg" style="height: 20px; width: 20px">
                        <defs>
                            <style>
                                .cls-1 {
                                    fill: #1a2947;
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', 'emojiarea-editor', function() {
            ...
            $(document).on('click', 'li.post-edit', function() {
                ...
                $(document).on('click', '.edit-post-save', function() {
                    var postid = $(this).data('postid');
                    var userid = $(this).data('userid');
                    var editedText = $(this).data('.edit-post-submit').siblings('.edit-post-value').find('.editStatus');
